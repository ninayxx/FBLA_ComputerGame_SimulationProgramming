...
- **Description:** A code assembling challenge where players drag and drop lines of Javascript code into the correct order to solve a logic prompt. Players must also identify and avoid distractor blocks that don't belong in the final solution.
- **Scoring:**
  - **Accuracy:** Percentage of the 5 hidden test cases passed successfully.
  - **Speed:** 1.5-minute grace period (90 seconds), as this is the most cognitively demanding task.
...
- **Scoring:**
  ...
  - **Speed:** 1-minute grace period (60 seconds).
